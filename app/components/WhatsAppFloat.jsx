    ...
    <a
     ...
     title="Cotizar por WhatsApp"
      ...
      >
        ...
        {/* Ping dot */}
        <span style={{ position: "absolute", top: 4, right: 4, width: 12, height: 12, background: "white", borderRadius: "50%", border: "2px solid #25D366", animation: "pulse 2s ease-in-out infinite" }} />
      </a>
  );
}